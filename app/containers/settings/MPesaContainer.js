            ...
            <SafeAreaView style={[STYLES.container, {alignItems: 'center'}]}>
            {
                ...
                <KeyboardAwareScrollView scrollEventThrottle={16}
                    ...
                    <View style = {styles.input_comment}>
                            <Text style = {styles.comment_text}>M-Pesa Details</Text>
                        </View>
                        <View style = {styles.input_comment}>
                    ...
                    <View style = {styles.input_component}>
                        ...
                        <View style = {styles.input_text_view}>
                            <TextInput editable={false} selectTextOnFocus={false} style = {styles.input_text} placeholder = {'Display Name'} onChangeText = {(text) => this.setState({phone_number: text})}>{this.state.phone_number}</TextInput>
                        </View>
                        <View style = {styles.input_comment}>
                        <Text style = {styles.comment_text}></Text>
                        <Text style = {styles.comment_text}>Top Up Amount</Text>
                        </View>
                    </View>
                    <TouchableOpacity style = {{width: '100%', height: 40, marginTop: 20, justifyContent: 'center', alignItems: 'center', backgroundColor: '#ffffff', borderRadius: 5}}>
                        <Text style = {[{fontSize: 18, color: '#000000', fontFamily: FONTS.type.Bold,}]}>50 MZN</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style = {{width: '100%', height: 40, marginTop: 20, justifyContent: 'center', alignItems: 'center', backgroundColor: '#ffffff', borderRadius: 5}}>
                        <Text style = {[{fontSize: 18, color: '#000000', fontFamily: FONTS.type.Bold,}]}>100 MZN</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style = {{width: '100%', height: 40, marginTop: 20, justifyContent: 'center', alignItems: 'center', backgroundColor: '#ffffff', borderRadius: 5}}>
                        <Text style = {[{fontSize: 18, color: '#000000', fontFamily: FONTS.type.Bold,}]}>200 MZN</Text>
                    </TouchableOpacity>
